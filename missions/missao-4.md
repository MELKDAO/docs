...
This field shows the total monetary value we have, in dollars, taking our balance into account. Since we do not have any MATIC token, our monetary value is 0. But if we had 1 MATIC token, for example, the value displayed in this field would be based on the token [currency price](https://coinmarketcap.com/currencies/polygon/). At the moment I write this, the MATIC is worth U$1.69.
