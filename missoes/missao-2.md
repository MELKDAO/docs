...
Em outras palavras, quando transfiro um token para você, eu não mando nenhum arquivo para o seu computador. Por isso, se você formatar o computador, você não perde os seus tokens, desde que você tenha salvo as palavras da Frase de Recuperação Secreta.

Você perde os seus tokens se um dia você perder suas palavras da Frase de Recuperação Secreta. Porque as palavras são a chave para que você consiga enviar uma transação para o blockchain que manipule os tokens da sua carteira.
